...
class ImplicationQaService:
    ...
    async def create_implication_qa(self, implication_id: str, question: str, answer: str,
    ...
    async def get_implication_qa_by_id(self, qa_id: str) -> ImplicationQaModel:
    ...
    async def get_implication_qa_by_query(self, implication_id: Optional[str] = None,
        ...
        try:
            ...
            qa_list = await self.qa_repository.get_all_implication_qa(
    ...
    async def update_implication_qa(self, qa_id: str, update_data: Dict[str, Any]) -> ImplicationQaModel:
        ...
        try:
            ...
            # Check if QA exists
            existing_qa = await self.get_implication_qa_by_query(qa_id)
            
            # Prepare update data (remove None values)
            clean_update_data = {k: v for k, v in update_data.items() if v is not None}
            
            updated_qa = await self.qa_repository.update_implication_qa(
