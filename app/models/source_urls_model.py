"""
Source URLs Model - Matches SQLAlchemy schema structure
Handles source URLs data operations with DynamoDB
"""
...
class SourceUrlsModel(BaseModel):
    """Source URLs model matching SQLAlchemy schema"""
    
    # SQLAlchemy: id (UUID) -> DynamoDB: pk (String)
    pk: str = Field(..., description="Source URL ID (UUID as string)")
    ...
    def create_new(cls, request_id: str, url: str, source_name: Optional[str] = None, 
        ...
        """Create a new source URL instance"""
    ...
    @classmethod
    def from_dict(cls, data: Dict[str, Any]) -> 'SourceUrlsModel':
