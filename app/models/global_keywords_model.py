"""
Global Keywords Model - Matches SQLAlchemy schema structure
Handles global keywords data operations with DynamoDB
"""
...
class GlobalKeywordsModel(BaseModel):
    """Global keywords model matching SQLAlchemy schema"""
    ...
    def create_new(cls, keyword: str, keyword_type: Optional[str] = None) -> 'GlobalKeywordsModel':
        """Create a new global keyword instance"""
    ...
    @classmethod
    def from_dict(cls, data: Dict[str, Any]) -> 'GlobalKeywordsModel':
